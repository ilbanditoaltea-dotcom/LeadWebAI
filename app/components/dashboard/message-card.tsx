    ...
    >
      <div className="rounded-2xl border border-violet-100 bg-[#f8fafc] p-4">
        <p className="text-sm leading-relaxed text-[#0f172a]">
          Hola equipo de Clínica Sonrisa+, hemos analizado vuestra presencia digital y
          detectamos oportunidades claras para captar más pacientes desde móvil. Preparamos una
          demo personalizada con una estructura orientada a conversión para que la podáis revisar
